...
class dctListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by dctParser#components.
    def enterComponents(self, ctx:dctParser.ComponentsContext):
        pass

    # Exit a parse tree produced by dctParser#components.
    def exitComponents(self, ctx:dctParser.ComponentsContext):
        pass
    ...
    # Enter a parse tree produced by dctParser#certificates.
    def enterCertificates(self, ctx:dctParser.CertificatesContext):
        pass

    # Exit a parse tree produced by dctParser#certificates.
    def exitCertificates(self, ctx:dctParser.CertificatesContext):
        pass
