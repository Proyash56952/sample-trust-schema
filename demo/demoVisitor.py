...
class demoVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by demoParser#st.
    def visitSt(self, ctx:demoParser.StContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by demoParser#s1.
    def visitS1(self, ctx:demoParser.S1Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by demoParser#s2.
    def visitS2(self, ctx:demoParser.S2Context):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by demoParser#s3.
    def visitS3(self, ctx:demoParser.S3Context):
        return self.visitChildren(ctx)
